    ...
    <div class="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-8 mb-8 text-white">
        <div class="flex flex-col md:flex-row items-center justify-between">
            <div>
                ...
                <p class="text-green-100 mb-4">Kelola usaha <strong>{{ Auth::user()->business_name ?? 'Anda' }}</strong>
                    dengan mudah</p>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8">
        <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
                <div class="bg-green-100 p-3 rounded-lg"><i class="fa-solid fa-money-bill-wave text-green-600 text-xl"></i>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
                <div class="bg-orange-100 p-3 rounded-lg"><i class="fa-solid fa-shopping-cart text-orange-600 text-xl"></i>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition">
            <div class="flex items-center justify-between mb-4">
                <div class="bg-purple-100 p-3 rounded-lg"><i class="fa-solid fa-chart-line text-purple-600 text-xl"></i>
                </div>
                                ...
                                <tr>
                                    <td colspan="6" class="px-4 py-8 text-center">
                                        <div class="flex flex-col items-center justify-center text-gray-500">
                                            ...
                                            <p class="text-sm mb-4">Toko Anda masih kosong. Yuk, mulai tambahkan
                                                produk!
                                            </p>
                                            <a href="{{ route('owner.produk.create') }}"
                            ...
                            <div class="border border-gray-200 rounded-lg p-4 hover:border-green-300 transition">
                                <div class="flex items-start justify-between mb-3">
                                    ...
                                    @elseif($order->status == 'processing')
                                        <span
                                            class="text-xs px-3 py-1 rounded-full bg-blue-100 text-blue-700 font-semibold">
                                ...
                                <div class="flex items-center justify-between border-t border-gray-100 pt-3">
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        @if ($order->status == 'pending')
                                            <form action="{{ route('owner.pesanan.update-status', $order->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PATCH')
