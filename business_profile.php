...
<head>
    ...
    <title><?= htmlspecialchars($selected['name']) ?> — Profil Bisnis — UMKMTerdekat</title>
    ...
    <main class="py-12">
        <div class="max-w-6xl mx-auto px-6">
            <nav class="text-sm text-gray-500 mb-6">
                <a href="index.php" class="hover:text-green-600">Beranda</a> <span class="mx-2">/</span>
                <a href="business.php" class="hover:text-green-600">Usaha</a> <span class="mx-2">/</span>
                <span class="text-gray-800"><?= htmlspecialchars($selected['name']) ?></span>
            </nav>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 items-start">
                    ...
                    <div class="md:col-span-1 flex items-center justify-center">
                        <div class="w-full max-w-md bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 text-center">
                            <div class="text-[6rem] mb-4"><?= htmlspecialchars($selected['logo']) ?></div>
                            <div class="text-sm text-gray-500"><?= htmlspecialchars($selected['category']) ?></div>
                            <div class="font-semibold text-lg text-gray-900"><?= htmlspecialchars($selected['name']) ?></div>
                            <div class="text-xs text-gray-500">Pemilik: <?= htmlspecialchars($selected['owner']) ?></div>

                            <div class="mt-4 flex items-center justify-center gap-2">
                                <div class="text-xs text-gray-500"><?= htmlspecialchars($selected['opening_hours']) ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-gray-700 mb-4"><?= htmlspecialchars($selected['description']) ?></p>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <div class="text-gray-600 space-y-1">
                                    <div><strong>Alamat:</strong> <?= htmlspecialchars($selected['address']) ?></div>
                                    <div><strong>Telepon:</strong> <?= htmlspecialchars($selected['phone']) ?></div>
                                    <div><strong>Email:</strong> <?= htmlspecialchars($selected['email']) ?></div>
                                    <div><strong>Instagram:</strong> <?= htmlspecialchars($selected['instagram']) ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 text-sm text-gray-500">
                            <strong>Jam Operasional:</strong> <?= htmlspecialchars($selected['opening_hours']) ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section id="produk" class="mt-12">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-bold text-gray-900">Produk dari <?= htmlspecialchars($selected['name']) ?></h2>
