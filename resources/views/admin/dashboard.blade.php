...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition">
                <div class="flex items-center justify-center mb-4">
                    <div class="bg-purple-100 p-3 rounded-lg"><i class="fa-regular fa-circle-check text-purple-600 text-xl"></i>
                    </div>
                </div>
                                ...
                                @forelse ($umkmList as $umkm)
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-4 py-3">
                                            ...
                                            <div class="font-medium text-gray-900">{{ $umkm->business ?? $umkm->business_name }}
                                            </div>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center justify-center space-x-2">
                                                <a href="{{ route('business.profile', $umkm->id) }}" class="text-blue-600 hover:bg-blue-50 p-2 rounded-lg transition"
                                                    title="Lihat">
                    ...
                    <div class="space-y-4">
                        <div class="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span
                                    class="text-2xl font-bold text-yellow-600">{{ $pendingApprovals['umkm_new'] }}</span>
                            </div>
                        ...
                        <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <span
                                    class="text-2xl font-bold text-blue-600">{{ $pendingApprovals['product_new'] }}</span>
                            </div>
