        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex items-center justify-between">
                ...
                <nav id="menu" class="hidden lg:flex items-center space-x-8">
                    ...
                    <a href="products.php" class="text-green-600 font-semibold">Produk</a>
            ...
            <div id="mobile-menu"
                ...
                <a href="products.php" class="block text-green-600 font-semibold">Produk</a>
    ...
    <main class="py-12">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="business.php" class="text-green-600 hover:underline">← Kembali</a>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <?php foreach ($products as $p): ?>
                    <div class="bg-white rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-2xl transition transform hover:-translate-y-1">
                        ...
                        <div class="text-center mb-2">
                            <span class="text-xs bg-green-100 text-green-700 px-3 py-1 rounded-full"><?= htmlspecialchars($p['category'], ENT_QUOTES, 'UTF-8') ?></span>
                        </div>
                        <h3 class="font-semibold text-gray-900 mb-1 text-lg text-center"><?= htmlspecialchars($p['name'], ENT_QUOTES, 'UTF-8') ?></h3>
                        <p class="text-green-600 font-bold text-center"><?= htmlspecialchars($p['price'], ENT_QUOTES, 'UTF-8') ?></p>
                        <p class="text-gray-500 text-sm mb-3 text-center"><i class="fa-solid fa-shop mr-2"></i><?= htmlspecialchars($p['seller'], ENT_QUOTES, 'UTF-8') ?></p>
                        <p class="text-gray-600 text-sm mb-4 leading-relaxed"><?= htmlspecialchars($p['description'], ENT_QUOTES, 'UTF-8') ?></p>
                        <div class="mt-4">
                            <a href="detail_product.php?id=<?= urlencode($p['id']) ?>" class="w-full inline-block bg-green-600 hover:bg-green-700 text-white py-2.5 rounded-lg text-sm font-semibold text-center">Lihat Produk</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
