                    ...
                    <div class="mb-6">
                        ...
                        <select id="product_category" name="product_category" required
                            ...
                            @foreach (['minuman' => 'Minuman', 'makanan' => 'Makanan', 'snack' => 'Snack', 'lainnya' => 'Lainnya'] as $val => $label)
                                <option value="{{ $val }}"
                                    {{ old('product_category', $product->category) == $val ? 'selected' : '' }}>
                                    {{ $label }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select name="product_status"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition">
                                <option value="active"
                                    {{ old('product_status', $product->status) == 'active' ? 'selected' : '' }}>
                                    Aktif</option>
                                <option value="inactive"
                                    {{ old('product_status', $product->status) == 'inactive' ? 'selected' : '' }}>
                                    Arsipkan</option>
                            </select>
                        </div>
                    </div>
